...
// preparing privious post
	
	jQuery(".prev-post").removeClass();
	jQuery(".nav-controls .previous a").wrap("<li>");
	jQuery(".nav-controls .previous li").wrapAll("<ul>");
	
// preparing next post

	jQuery(".next-post").removeClass();
	jQuery(".nav-controls .next a").wrap("<li>");
	jQuery(".nav-controls .next li").wrapAll("<ul>");
