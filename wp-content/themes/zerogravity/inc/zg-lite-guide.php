...
.col-left {float:left; width: 60%; padding-right:14px; border-right:1px solid #ccc;}
.col-right {float:left; width: 32%; padding-left:21px;}
...
<div class="wrapper">
	...
	<div class="col-right">
		<h1 style="margin-bottom:0;"><span class="pro-title"></span> ZeroGravity Pro</a></h1>
		...
		<ul>
			...
			<li><span class="check-lista"></span> <?php _e('Custom widgets (Recent posts with thumbnails, Popular posts with thumbnails, Email subscription)', 'zerogravity'); ?></li>
