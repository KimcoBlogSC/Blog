...
function mobileResponsivenessFix(){	
	jQuery(".nav-controls .previous a").removeClass().wrap( "<li></li>" );	
	jQuery(".nav-controls .previous li").wrapAll("<ul></ul>");
	
	jQuery(".nav-controls .next a").removeClass().wrap( "<li></li>" );	
	jQuery(".nav-controls .next li").wrapAll("<ul></ul>");
